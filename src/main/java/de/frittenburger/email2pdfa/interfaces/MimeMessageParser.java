...
public interface MimeMessageParser {
	...
	String getTargetDir(String emlFile, Sandbox sandbox) throws MimeMessageParserException;
	
	void parse(String emlFile, Sandbox sandbox) throws MimeMessageParserException;
